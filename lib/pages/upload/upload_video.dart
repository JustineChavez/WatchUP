...
class UploadVideoPage extends StatefulWidget {
  String topicId;
  UploadVideoPage({Key? key, required this.topicId}) : super(key: key);
...
class _UploadVideoPageState extends State<UploadVideoPage> {
  ...
  Future uploadVideo() async {
    final path = "videos/${widget.topicId}/${pickedFile!.name}";
  ...
  addVideoURL(String uuurrrlll) {
    ...
    DatabaseService().addVideoContent(widget.topicId, fileContentMap);
  }
  ...
  addVideo() async {
    if (pickedFile!.name.isNotEmpty) {
      Map<String, dynamic> fileContentMap = {
        "id": "",
        "content": pickedFile!.name,
        "content2": "videos/${widget.topicId}/${pickedFile!.name}",
        "time": DateTime.now().millisecondsSinceEpoch,
      };
      //print(widget.topicId);
