...
class UploadProfilePicturePage extends StatefulWidget {
  String email;
  UploadProfilePicturePage({Key? key, required this.email}) : super(key: key);
...
class _UploadProfilePicturePageState extends State<UploadProfilePicturePage> {
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        Locales.string(context, "profile_pic_upload"),
                        style: TextStyle(
                            color: Constants().customBackColor,
                            fontSize: 23,
  ...
  Future uploadImage() async {
    ...
    final path = "profilePicture/${widget.email}/${pickedFile!.name}";
  ...
  addImageURL(String uuurrrlll) {
    DatabaseService().uploadProfilePic(widget.email, uuurrrlll);
  }
}
