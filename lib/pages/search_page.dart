  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          Locales.string(context, "group_search"),
          style: TextStyle(
              fontSize: 20,
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: Locales.string(context, "group_search_hint"),
                        hintStyle: TextStyle(
        ...
        onTap: () async {
          ...
          if (isJoined) {
            ...
            showSnackbar(context, Constants().customColor1,
                Locales.string(context, "group_join_success"));
            ...
            setState(() {
              ...
              showSnackbar(context, Constants().customColor2,
                  "${Locales.string(context, "group_left_success")} $groupName");
            });
          }
        },
        child: isJoined
            ? Container(
                ...
                child: Text(
                  Locales.string(context, "group_joined"),
                  style: TextStyle(color: Constants().customBackColor),
                ),
              )
            : Container(
                ...
                padding:
                    const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                child: Text(Locales.string(context, "group_join"),
                    style: TextStyle(color: Constants().customBackColor)),
              ),
      ),
    );
